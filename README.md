...
<details>
  <summary>11. Offline Web Applications - optional </summary>
</details>
<details>
  <summary>12. Memory pair game — real project! </summary>
  <h2>Memory – Pair Game</h2>
  <ol>
    <li>У цьому розділі я створив Memory - Pair Game — карткову гру, в якій всі картки кладуться на поверхню лицьовою стороною вниз, і кожен раз перевертаються по дві картки. Мета гри - знайти пари відповідних карток. Гра закінчується, коли буде підібрана остання пара.<br>
      <a href='https://vladimirrutskiy.github.io/Memory-Pair-Game/'>DEMO</a><br>
      <a href='https://github.com/VladimirRutskiy/Memory-Pair-Game'>Code</a>
    </li>
    <p>Ось саме це завдання дало мені зрозуміти, що я кайфую від написання коду. Три рази переписував основну логіку, кожна вільна хвилина витрачена на придумування логіки, перше завдання написано повністтю по моїм міркуванням. Починалося все з моменту ступору, але кожен крок росписаний у блокнот, дав хоча б мінімальне пояснення що робити. І так крок за кроком я завершив це завдання.Знаю, що можна додати ще пару функцій, для покращення гри, але поки переключаюсь на наступне завдання, так як до кінця курсу залишилось обмаль часу.</p>
  </ol>
</details>
<details>
  <summary>13. Website Performance Optimization - optional </summary>
</details>
<details>
  <summary>14. Friends App - real project! </summary>
  <h2>Friends App</h2>
  <ol>
    <li>Створив невеличку сторінку пошуку друзів у соціальних мережах з картками користувачів, пошуком, сортуванням та фільтрацією їх за віком, прізвищем, ім'ям, або чим завгодно, за допомогою Random User API :)<br>
      <a href='https://vladimirrutskiy.github.io/friends-app/'>DEMO</a><br>
      <a href='https://github.com/VladimirRutskiy/friends-app'>Code</a>
    </li>
  </ol>
</details>
